...
class Gemini(Base):
    ...
    def parse_response(self, response: dict) -> dict:
        ...
        Reasoning ("thought") parts and tool_use parts both carry a
        thoughtSignature the API wants echoed back unchanged on continuation."""
    ...
    def _thinking_config(self) -> dict:
        # The "LOW" branch is currently unreachable: its model isn't in
        # MODELS (commented out above), preserved here to match the Ruby
        # reference exactly rather than simplified away.
